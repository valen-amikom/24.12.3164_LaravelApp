    ...
    <nav
        ...
        <div class="hidden md:flex items-center gap-8 font-medium">
            ...
            <a href="/admin/dashboard"
               class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-semibold shadow-lg shadow-indigo-200 transition">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div class="space-y-4 col-span-2">
                ...
                <p class="max-w-xs text-indigo-300">
                    ...
                    untuk mahasiswa dan penyelenggara profesional.
